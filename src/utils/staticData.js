...
export const cases = [
  {
    imgSrc: Case1,
    name: "5th & Atwood Transit Canopies",
...
export const details = [
  {
    head: "Owner: ",
    content: "Port Authority of Allegheny County; Pittsburgh, PA",
  },
  {
    head: "Architect: ",
    content: "Greg Maynes, Moshier Studio; Pittsburgh",
  },
  {
    head: "Photographer: ",
    content: "Dave Bryce Photography",
  },
  {
    head: "Glass Fabricator: ",
    content: "Viracon; Owatonna, Minnesota",
  },
  {
    head: "Engineer, Fabricator, Installer: ",
    content: "EXTECH/Exterior Technologies, Inc.; Pittsburgh",
  },
]
...
export const factors = [
  ...
  {
    icon: Factor,
    name: "Window-to-floor ratio",
  },
  {
    icon: Factor,
    name: "Skylight-to-floor ratio",
  },
  {
    icon: Factor,
    name: "Weather data",
...
export const general_team = [
  ...
  {
    name: "Kevin Smith, RA",
    role: "Director, Product Application and Development",
    avatar: Kevin,
    to: "kevin-smith",
  },
  {
...
export const sales_team = [
  ...
  {
    name: "Ron Clelland",
    role: "Architectural Representative, NYC and NJ",
    avatar: Ron,
    to: "ron-clelland",
  },
]

export const sheeting = [
  {
    name: "Standing Seam",
    list: [
...
export const icons = [
  { icon: Daylight, text: "Comfortable, diffused daylighting" },
  { icon: Resistance, text: "High-impact resistance" },
  { icon: Testing, text: "Air, water, structural testing" },
  { icon: USA, text: "Manufactured in U.S.A" },
]
...
export const questions = [
  {
    ...
    answer:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mattis, nibh a luctus faucibus, purus leo dictum libero, vel imperdiet purus sapien a orci. Nunc id vulputate est, ut maximus tortor. Maecenas id feugiat nunc, eget sagittis risus. Fusce est lectus, cursus ut mi sit amet, volutpat mattis est. Nulla egestas justo ac magna tincidunt, vitae efficitur diam porttitor. In egestas dictum faucibus. Fusce vel magna sodales, accumsan libero ut, bibendum lorem. Donec ultrices magna id justo ultrices, vel elementum quam aliquam. Donec laoreet auctor convallis. Etiam bibendum lobortis arcu, vel auctor metus aliquet eget. ",
  },
  {
    question: "Aliquam blandit faucibus nunc non hendrerit.",
    answer:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mattis, nibh a luctus faucibus, purus leo dictum libero, vel imperdiet purus sapien a orci. Nunc id vulputate est, ut maximus tortor. Maecenas id feugiat nunc, eget sagittis risus. Fusce est lectus, cursus ut mi sit amet, volutpat mattis est. Nulla egestas justo ac magna tincidunt, vitae efficitur diam porttitor. In egestas dictum faucibus. Fusce vel magna sodales, accumsan libero ut, bibendum lorem. Donec ultrices magna id justo ultrices, vel elementum quam aliquam. Donec laoreet auctor convallis. Etiam bibendum lobortis arcu, vel auctor metus aliquet eget. ",
  },
  {
    question: "Nam sollicitudin, nisl id laoreet volutpat",
    answer:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mattis, nibh a luctus faucibus, purus leo dictum libero, vel imperdiet purus sapien a orci. Nunc id vulputate est, ut maximus tortor. Maecenas id feugiat nunc, eget sagittis risus. Fusce est lectus, cursus ut mi sit amet, volutpat mattis est. Nulla egestas justo ac magna tincidunt, vitae efficitur diam porttitor. In egestas dictum faucibus. Fusce vel magna sodales, accumsan libero ut, bibendum lorem. Donec ultrices magna id justo ultrices, vel elementum quam aliquam. Donec laoreet auctor convallis. Etiam bibendum lobortis arcu, vel auctor metus aliquet eget. ",
  },
  {
    question: "Orci purus lacinia justo, eget.",
    answer:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mattis, nibh a luctus faucibus, purus leo dictum libero, vel imperdiet purus sapien a orci. Nunc id vulputate est, ut maximus tortor. Maecenas id feugiat nunc, eget sagittis risus. Fusce est lectus, cursus ut mi sit amet, volutpat mattis est. Nulla egestas justo ac magna tincidunt, vitae efficitur diam porttitor. In egestas dictum faucibus. Fusce vel magna sodales, accumsan libero ut, bibendum lorem. Donec ultrices magna id justo ultrices, vel elementum quam aliquam. Donec laoreet auctor convallis. Etiam bibendum lobortis arcu, vel auctor metus aliquet eget. ",
  },
]
...
export const selectData = {
  0: [
    {
      name: "Autocad .dwg",
      content:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Congue ultricies.",
    },
    {
      name: "3D Studio Max .max ",
      content:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Congue ultricies.",
    },
    { name: "UniQuad 4in", content: "Long Span AutoCAD Drawing" },
  ],
  1: [
    {
      name: "3D Studio Max .max ",
  ...
  2: [{ name: "UniQuad 4in", content: "Long Span AutoCAD Drawing" }],
  3: [
    {
      name: "Autocad .dwg",
      content:
